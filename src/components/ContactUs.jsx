          ...
          <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
            <div className="bg-violet-600 rounded-lg p-6 h-full max-lg:order-1">
              ...
              <p className="text-sm text-white mt-4">
                Have any query or question and need help?
              </p>
              ...
              <ul className="mt-16 space-y-8">
                ...
                <li className="flex items-center">
                  ...
                  <a
                    ...
                    className="text-sm text-white ml-4"
                  >
                    G.T Road, Engineering University Lahore, Lahore, 39161
                  </a>
                </li>
              </ul>
              ...
              <ul className="flex flex-wrap gap-4 mt-16">
                <li className="bg-white hover:bg-slate-100 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="https://www.facebook.com/CenterForLanguageEngineering/" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18px"
                      height="18px"
                ...
                <li className="bg-white hover:bg-slate-100 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="https://www.linkedin.com/company/center-for-language-engineering/" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18px"
                      height="18px"
                ...
                <li className="bg-white hover:bg-slate-100 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="https://www.instagram.com/centerforlanguageengineering/" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18px"
                      height="18px"
